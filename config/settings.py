...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'utils.pagination.CustomPagination',  # ← ADDED
    'PAGE_SIZE': 10,  # ← ADDED
    ...
    'EXCEPTION_HANDLER': 'utils.exceptions.custom_exception_handler',  # ← ADDED
}

# JWT Settings - ADD THIS SECTION
SIMPLE_JWT = {
...
GOOGLE_CREDENTIALS_FILE = BASE_DIR / os.getenv("GOOGLE_CREDENTIALS_FILE", "")
GOOGLE_SCOPES = [
